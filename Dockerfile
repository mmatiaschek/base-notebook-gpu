...
MAINTAINER Alex Burnap <aburnap@mit.edu> build on Jupyter Project <jupyter@googlegroups.com>
...
# Create UROP_student user with UID=1000 and in the 'users' group
...
# Install conda as UROP_student and check the md5 sum provided on the download site
...
# Switch back to UROP_student to avoid accidental container runs as root
USER $NB_USER
